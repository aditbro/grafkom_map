...
all: main.c data_structures/Shape/Shape.c data_structures/Line/Line.c data_structures/Point/Point.c data_structures/Buffer/Buffer.c data_structures/Color/Color.c svg_reader/PathDataProcessing/pathToLines.c svg_reader/SVGReader/svgReader.c data_structures/Letters/Letters.c
	$(CC) -g -Wall -o main main.c  data_structures/Shape/Shape.c data_structures/Line/Line.c data_structures/Point/Point.c data_structures/Buffer/Buffer.c data_structures/Color/Color.c algorithm/down_scaling/down_scaling.c data_structures/Object/Object.c svg_reader/PathDataProcessing/pathToLines.c svg_reader/SVGReader/svgReader.c data_structures/Letters/Letters.c -ggdb $(CFLAGS) $(LIB)
