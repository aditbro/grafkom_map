...
layer: main_layer.c data_structures/Shape/Shape.c data_structures/Line/Line.c data_structures/Point/Point.c data_structures/Buffer/Buffer.c data_structures/Color/Color.c svg_reader/PathDataProcessing/pathToLines.c svg_reader/SVGReader/svgReader.c
